...
class Seq2Seq(nn.Module):
    ...
    # src: Variable
    # tar: Variable
    # mode: image (src->image) o feature (src->feature)
    def forward(self, src, tar, src_len, mode, teacher_rate, train=True):
        ...
        #src = Variable(src)
        out_enc, hidden_enc = self.encoder(src, src_len, mode)
        # t,b,f    layers, b,f
